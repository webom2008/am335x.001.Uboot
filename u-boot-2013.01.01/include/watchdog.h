 ...
 */
	...
	#endif /* __ASSEMBLY__ */
#elif defined(CONFIG_EXTERNAL_WATCHDOG)
	#if defined(__ASSEMBLY__)
        #define WATCHDOG_RESET  /*XXX DO_NOT_DEL_THIS_COMMENT*/
        #define WATCHDOG_INIT   /*XXX DO_NOT_DEL_THIS_COMMENT*/
	#else
        extern void ext_watchdog_init(void);
        extern void ext_watchdog_reset(void);
        #define WATCHDOG_RESET  ext_watchdog_reset
        #define WATCHDOG_INIT   ext_watchdog_init
	#endif /* __ASSEMBLY__ */
#else
	/*
