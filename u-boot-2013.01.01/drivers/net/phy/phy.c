...
#define GPIO_PORT_BANK_PIN(band, pin) ((32*(band))+(pin))
					 ...
					 phy_interface_t interface)
{
    ...
    //add by QWB 20140512 start
    gpio_request(GPIO_PORT_BANK_PIN(0,16), "rmii rst");
    gpio_direction_output(GPIO_PORT_BANK_PIN(0,16), 1);
    mdelay(10);
    //add by QWB 20140512 end
